...
class StaticChecker(BaseVisitor, Utils):
    ...
    def visitProgram(self, ast, param):
        ...
        print("list", [self.list_of_function[0][i].body for i in self.list_of_function[0].keys()])
    ...
    def visitFuncDecl(self, ast, param):
        ...
        # print("check_exists_func ", check_exists_func)
        # print("list_of_function ", self.list_of_function)
        ...
        # if (param[0].get(ast.name.name) != None and param[0].get(ast.name.name).body == True):
        #     print("redeclared")
        #     raise Redeclared(Function(), ast.name.name)
        ...
        print("param in func: ", param[0])
        # param[0][ast.name.name] = listParam 
