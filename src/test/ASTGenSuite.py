...
class ASTGenSuite(unittest.TestCase):
    def test_declared(self):
        ...
        """
        expect = str(Program([
                VarDecl(Id("BaoKhanh"), NumberType())
            ]))
        ...
        """
        expect = str(Program([
                VarDecl(Id("BaoKhanh"), StringType(), None, NumberLiteral(1.0))
            ]))
        #print(expect)
        ...
        """
        expect = str(Program([
                VarDecl(Id("BaoKhanh"), StringType()),
                VarDecl(Id("BaoKhanh"), BoolType()),
                VarDecl(Id("BaoKhanh"), StringType(), None, NumberLiteral(1.0)),
                VarDecl(Id("BaoKhanh"), BoolType(), None, NumberLiteral(1.0))
            ]))
        #print(expect)
        ...
        """
        expect = str(Program([
                VarDecl(Id("BaoKhanh"), ArrayType([5.0], StringType()), None, NumberLiteral(1.0)),
                VarDecl(Id("BaoKhanh"), ArrayType([5.0], StringType()))
            ]))
        #print(expect)
        self.assertTrue(TestAST.test(input, expect, 304))
        
        input = """
            number BaoKhanh[5,3,4.2] <- 1
            bool BaoKhanh[2,3,4]
        """
        expect = str(Program([
                VarDecl(Id("BaoKhanh"), ArrayType([5.0, 3.0, 4.2], NumberType()), None, NumberLiteral(1.0)),
                VarDecl(Id("BaoKhanh"), ArrayType([2.0, 3.0, 4.0], BoolType()))
            ]))
        #print(expect)
        ...
        """
        expect = str(Program([
                    VarDecl(Id("BaoKhanh"), None, "dynamic", NumberLiteral(1.0)),
                    VarDecl(Id("BaoKhanh"), None, "dynamic")
                ]))
        #print(expect)
        ...
        """
        expect = str(Program([
                    VarDecl(Id("BaoKhanh"), None, "var", NumberLiteral(1.0))
                ]))
        #print(expect)
        ...
        expect = str(Program([
                    ...
                    FuncDecl(Id("main"), [VarDecl(Id("BaoKhanh"), ArrayType([1.0, 2.0], NumberType()))], Return(None))
                ]))
        # print(expect)
